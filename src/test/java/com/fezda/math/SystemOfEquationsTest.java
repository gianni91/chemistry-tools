...
public class SystemOfEquationsTest {
	...
	public void testCopyMatrix() {
		...
		double [][] copy = SystemOfEquations.getCopy(matrix);
	...
	public void testSolveSimpleSystemOfEquations1() {
		...
		double [] result = SystemOfEquations.solveSimpleSystemOfEquations(system);
	...
	public void testSolveSimpleSystemOfEquations8() {
		...
		double [] result1 = SystemOfEquations.solveSimpleSystemOfEquations(system1);
		double [] result2 = SystemOfEquations.solveSimpleSystemOfEquations(system2);
	...
	public void testSolveSimpleSystemOfEquations10() {
		...
		double [] result1 = SystemOfEquations.solveSimpleSystemOfEquations(system1);
		double [] result2 = SystemOfEquations.solveSimpleSystemOfEquations(system2);
		double [] result3 = SystemOfEquations.solveSimpleSystemOfEquations(system3);
